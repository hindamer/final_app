            ...
            <div class="col-md-3 left_col">
                <div class="left_col scroll-view">
                    <div class="navbar nav_title" style="border: 0;">
                        <a href="/index" class="site_title"><i class="fa fa-graduation-cap"></i></i> <span>Beverages</span></a>
                    </div>
							...
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-desktop"></i> Beverages <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										...
										<li><a href="/data">Beverages List</a></li>
									</ul>
								</li>
								<li><a><i class="fa fa-desktop"></i> Messages <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="/mails">Meessages</a></li>
									</ul>
								</li>
							</ul>
						</div>
                    ...
                    <nav class="nav navbar-nav">
                        <ul class=" navbar-right">
                            ...
                            <li role="presentation" class="nav-item dropdown open">
                                ...
                                @foreach($nums as $num) 
                                <li class="nav-item">
                                        <a href="/showmessage/{{$num->id}}" class="dropdown-item">
                                            <span class="image"><img src="{{asset('images/img.jpg')}}" alt="Profile Image" /></span>
                                            <span>
                                                <span>{{$num->name}}</span>
                                                <span class="time">{{$num->created_at}}</span>
                                            </span>
                                            <span class="message">
                                                {{$num->message}}
                                            </span>
